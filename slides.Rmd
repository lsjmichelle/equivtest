...
devtools::install_github('lsjmichelle/ecopower@3803ec5')
```
...
fish = data.frame(matrix(nrow=2,ncol=20,dimnames = list(NULL, colnames(abund))))
fish[1:2,] = 1
...
lines(1:20, fish[2,], col='red',type='o')
legend(
  "bottom", legend=c("Reference", "Restored"), lty=c(1,1), title="", lwd = 1,
